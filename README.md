...
**Friends**
- Built on iOS Contacts — no account required
- Me view with profile avatar, Featured picks, and Excited For upcoming releases
- Share your watchlist and watched history with friends, or keep everything private
...
**Friends** is a social tab built on iOS Contacts — no account required. The **Me** view shows your profile, your **Featured** picks (your top favourites by default, editable with the pencil icon), and an **Excited For** section for upcoming releases you're looking forward to — items automatically expire from this list once they're released. You can choose to share your watchlist, your watched history, or keep everything private. The **Friends** view lists contacts who have Vestigo installed, ordered by recent activity, with an invite button to bring more friends in. Tapping a friend opens their profile with featured picks and, if they've chosen to share, their watchlist and watched history.
